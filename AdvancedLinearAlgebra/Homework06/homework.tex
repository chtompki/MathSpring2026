...
\begin{document}
    ...
    \begin{onehalfspace}
        ...
        % P.4.10
        \noindent\textbf{P.4.10.} For $X\in\mathbf{M}_{m\times n}$, $\mathcal{v}(X)$ denote the nullity of $X$.
        \begin{enumerate}[label=(\alph*)]
            \item Show that $\mathcal{v}(X^\top) = \mathcal{v}(X) + m - n$.
            \item Let $A\in\mathbf{M}_{m\times k}$
        \end{enumerate}
        \begin{solution}
        \end{solution}
