...
% Do not cite any references in the abstract.
    ...
    But, in 1930 through his numbering system and
    ...
    what is it? TRUTH it seems has been obscurred for nearly  
    A SYSTEM OF REFERENTIAL CAPACITY, born/bourne (both simultaneously there) out
    Newton's third law (upon
    which we will expound at a later time),
    so let's define one.
...
% DOTTED TABLE DRAWING:
    ...
    \begin{figure}[htbp]
        ...
        \caption{A photo of page 1 of this handwritten paper for the purposes of self referentiality}
    \end{figure}

    \begin{figure}[htbp]
        \centering
        \includegraphics[width=0.4\textwidth]{math2_small.jpeg}
        \caption{A photo of page 2 of this handwritten paper for the purposes of self referentiality}
    \end{figure}

    \begin{figure}[htbp]
        \centering
        \includegraphics[width=0.4\textwidth]{math3_small.jpeg}
        \caption{A photo of page 3 of this handwritten paper for the purposes of self referentiality}
    \end{figure}

    \begin{figure}[htbp]
        \centering
        \includegraphics[width=0.4\textwidth]{math4_small.jpeg}
        \caption{A photo of page 4 of this handwritten paper for the purposes of self referentiality}
    \end{figure}
